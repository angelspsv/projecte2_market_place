...
class SellerEditProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.seller_edit_profile_activity)

        val fieldMap = mutableMapOf<String, EditText>()

        fieldMap["dni"] = findViewById(R.id.seller_edit_profile_dni)
        fieldMap["name"] = findViewById(R.id.seller_edit_profile_name)
        fieldMap["surname"] = findViewById(R.id.seller_edit_profile_surname)
        fieldMap["email"] = findViewById(R.id.seller_edit_profile_email)
        fieldMap["password"] = findViewById(R.id.seller_edit_profile_password)
        fieldMap["phone"] = findViewById(R.id.seller_edit_profile_phone)
        fieldMap["comarca"] = findViewById(R.id.seller_edit_profile_comarca)
        fieldMap["iban"] = findViewById(R.id.seller_edit_profile_iban)

        val saveButton: Button = findViewById(R.id.seller_edit_profile_save_button)
